...
#  here for room in self.rooms:
    
# Python-এ dictionary-এর উপর loop করলে keys এর মাধ্যমে iteration হয়।

# তাই room এর মান হবে শুধু key, অর্থাৎ 'A' অথবা 'B'।

# না, 'A': 'Clean' এর মত key-value pair নয়।
